...
export default function AiAssistantView({
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      sender: 'AI',
      text: 'Halo! Saya adalah **NUSANTARA POS AI Admin**. Saya didukung oleh modul server-side Gemini Model. Saya bisa menganalisis performa keuangan cabang Anda, merekomendasikan strategi restocking, atau memprediksi omset harian. Silahkan pilih tombol aksi cepat di bawah atau tulis pertanyaan Anda!',
      timestamp: new Date()
    }
  ]);
        ...
        <div className="flex items-center justify-between border-b border-slate-200 pb-3 shrink-0">
          <div>
            <h1 className="text-sm font-black uppercase text-slate-900 tracking-wider flex items-center gap-1.5">
              ...
              <span>NUSANTARA POS AI Admin System (Gemini)</span>
            </h1>
